...
namespace CrossText.Service.Test
{
    ...
    public class SerializableSiteCacheTest
    {
        ...
        {
            SerializableSiteCacheConstructorTestHelper<int, String>();
        }
        ...
        {
            PrivateObject param0 = new PrivateObject(new SerializableSiteCache<TKey, TValue>(XmlFile));
            SerializableSiteCache_Accessor<TKey, TValue> target = new SerializableSiteCache_Accessor<TKey, TValue>(param0);
            TKey key = default(TKey); 
            CacheItem<TValue> expected = new CacheItem<TValue>();
            target.Insert(key, expected.Value);
        ...
        public void IsExpiredTestHelper<TKey, TValue>()
        {
            ...
            SerializableSiteCache<TKey, TValue> target = new SerializableSiteCache<TKey, TValue>(xmlFilePath); 
            TKey key = default(TKey);
            target.Insert(key, default(TValue));
            bool expected = false; 
            bool actual;
        ...
        {
            IsExpiredTestHelper<int, String>();
        }
        ...
        {
            WriteSerializedXmlTestHelper<int, String>();
        }
        ...
        public void DictionaryTestHelper<TKey, TValue>()
        {
            PrivateObject param0 = new PrivateObject(new SerializableSiteCache<TKey, TValue>(XmlFile));
            SerializableSiteCache_Accessor<TKey, TValue> target = new SerializableSiteCache_Accessor<TKey, TValue>(param0); 
            SerializableDictionary<TKey, CacheItem<TValue>> expected = new SerializableDictionary<TKey, CacheItem<TValue>>();
        ...
        {
            DictionaryTestHelper<int, String>();
        }
        ...
        public void ExpirySpanTestHelper<TKey, TValue>()
        {
            string xmlFilePath = XmlFile;
            SerializableSiteCache<TKey, TValue> target = new SerializableSiteCache<TKey, TValue>(xmlFilePath);
            TimeSpan expected = new TimeSpan(0, 1, 0, 0, 0);
            TimeSpan actual;
        ...
        {
            ExpirySpanTestHelper<int, String>();
        }
        ...
        {
            XmlFilePathTestHelper<int, String>();
        }
    }
}
