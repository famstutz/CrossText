...
namespace CrossText.Service.Test
{
    ...
    public class SerializableDictionaryTest
    {
        ...
        {
            SerializableDictionaryConstructorTestHelper<string, string>();
        }
        ...
        {
            GetSchemaTestHelper<string, string>();
        }
        ...
        public void ReadXmlTestHelper<TKey, TValue>()
        {
            ...
            XmlReader reader = XmlReader.Create(new MemoryStream(GetXmlSampleData()));
        ...
        {
            ReadXmlTestHelper<string, string>();
        }
        ...
        {
            WriteXmlTestHelper<string, string>();
        }
    }
}
